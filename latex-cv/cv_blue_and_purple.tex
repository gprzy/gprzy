...
\section{Experiência}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {$\rightarrow$ \color{purple}\texttt{Data Scientist}}{Jan. 2022 - o momento}
      \resumeItemListStart
        \resumeItem{}
    ...
    % Multiple positions
    \resumeSubSubheading
    {$\rightarrow$ \color{purple}\texttt{Engenheiro de Dados Pleno}}{Out. 2021 - Fev. 2022}
    \resumeItemListStart
        \resumeItem{}
    ...
    \resumeSubheading
      {Pontifícia Universidade Católica do Paraná}{Curitiba, Brasil}
      {$\rightarrow$ \color{purple}\texttt{PIBIC Researcher}}{Ago. 2020 - o momento}
      \resumeItemListStart
        \resumeItem{}
    ...
    \resumeSubheading
      ...
      {$\rightarrow$ \color{purple}\texttt{Data Engineer Intern}}{Nov. 2020 - Out. 2021}
      \resumeItemListStart
        \resumeItem{}
      ...
      % Multiple positions
      \resumeSubSubheading
      {$\rightarrow$ \color{purple}\texttt{Software Developer Intern}}{Mar. 2020 - Nov. 2020}
      \resumeItemListStart
        \resumeItem{}
    ...
    \resumeSubheading
      ...
      {$\rightarrow$ \color{purple}\texttt{Software Developer Intern}}{Jul. 2019 - Dez. 2019}
      \resumeItemListStart
        \resumeItem{}
